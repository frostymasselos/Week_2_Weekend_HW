...
^guests can have money that subtract when they pay entry_fee.
...
^guest have fav_song attribute
- Rooms can keep track of the entry fees/spending of the guests - maybe add a bar tab/bar class?
^general tab as well as individual tab. Requires remove_money_from_guest function.
